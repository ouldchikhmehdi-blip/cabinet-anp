...
- [x] **Abonnement iCal vivant IADE** (flux `/api/agenda-iade`, cumul par mois, Apple/Google/Outlook) — 2026-08-19 (cf. `IADE.md` § 10 bis)
- [ ] ⚠️ **Exécuter `supabase/iade_agenda.sql`** dans Supabase (SQL Editor) pour activer l'abonnement IADE
